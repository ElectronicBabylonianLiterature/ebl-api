...
class Museum(Enum):
    ...
    ERIMTAN_MUSEUM = museum_entries_a_l.ERIMTAN_MUSEUM
    GAZIANTEP_MUSEUM = museum_entries_a_l.GAZIANTEP_MUSEUM
    ...
    KAHRAMANMARAS_MUZESI = museum_entries_a_l.KAHRAMANMARAS_MUZESI
