...
def create_dossiers_routes(api: falcon.App, context: Context):
    ...
    dossiers_suggestions_resource = DossiersSuggestionsResource(
        context.dossiers_repository
    )
    ...
    api.add_route("/dossiers/suggestions", dossiers_suggestions_resource)
