...
def build_provenance_records(
    ...
    polygon_coordinates_map: Optional[Mapping[str, Sequence[GeoCoordinate]]] = None,
) -> Sequence[ProvenanceRecord]:
    coordinates_map = coordinates_map or {}
    polygon_coordinates_map = polygon_coordinates_map or {}
    return tuple(
        ProvenanceRecord(
            id=record["id"],
            ...
            polygon_coordinates=polygon_coordinates_map.get(record["id"]),
        )
