...
def test_get(photo_status, line_art_status, detail_line_art_status, client):
    cdli_number = 'P397611'
    photo_url = f'https://cdli.ucla.edu/dl/photo/{cdli_number}.jpg'
    line_art_url = f'https://cdli.ucla.edu/dl/lineart/{cdli_number}_l.jpg'
    detail_line_art_url = \
        f'https://cdli.ucla.edu/dl/lineart/{cdli_number}_ld.jpg'

    httpretty.register_uri(httpretty.HEAD, photo_url, status=photo_status)
    httpretty.register_uri(httpretty.HEAD,
                           line_art_url,
                           status=line_art_status)
    httpretty.register_uri(httpretty.HEAD,
                           detail_line_art_url,
                           status=detail_line_art_status)
    ...
    assert result.json == {
        ...
        'detailLineArtUrl': (detail_line_art_url
                             if STATUSES[detail_line_art_status]
                             else None)
    }
