...
def test_update_transliteration(fragment_updater,
                                user,
                                fragment_repository,
                                changelog,
                                when):
...
@freeze_time("2018-09-07 15:41:24.032")
def test_update_lemmatization(fragment_updater,
                              user,
                              fragment_repository,
                              changelog,
                              when):
...
def test_update_references(fragment_updater,
                           bibliography,
                           user,
                           fragment_repository,
                           changelog,
...
def test_update_references_invalid(fragment_updater,
    ...
    with pytest.raises(DataError):
        fragment_updater.update_references(
            number,
            references,
            user
        )
