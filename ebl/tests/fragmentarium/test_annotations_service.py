...
def test_update(
    ...
    expected_cropped_sign_image = CroppedSignImage("test-id", Base64("test-image"), fragment_number)
    ...
    when(cropped_sign_images_repository).delete_by_fragment_number(fragment_number).thenReturn()
