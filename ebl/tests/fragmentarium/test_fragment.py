...
def test_acquisition():
    ...
    fragment = FragmentFactory.build(acquisitions=(acquisition,))

    assert isinstance(fragment.acquisitions, tuple)
    assert isinstance(fragment.acquisitions[0], Acquisition)
    assert fragment.acquisitions[0].description == "Clay tablet purchase"
    assert fragment.acquisitions[0].supplier == "Antiquities Gallery"
    assert fragment.acquisitions[0].date == 1925

    fragment = FragmentFactory.build(acquisitions=())
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "ark_number",
        "ashmolean_number",
        "australianinstituteofarchaeology_number",
        "cambridge_maa_number",
        "chicago_isac_number",
        "digitale_keilschrift_bibliothek_number",
        "dublin_tcd_number",
        "etcsri_number",
        "harvard_ham_number",
        "kelsey_number",
...
def test_external_numbers():
    external_numbers = ExternalNumbers(
        cdli_number="P000002",
        bm_id_number="W_1848-0720-117",
        archibab_number="T16607",
        bdtns_number="169675",
        rsti_number="b57789ab-d923-4c7e-9905-d5f0129d2797",
        chicago_isac_number="13472a2e-8a5e-4ad7-a000-e2bebe7bc25e",
        ur_online_number="234",
        hilprecht_jena_number="30813",
        hilprecht_heidelberg_number="1116431",
        metropolitan_number="321966",
        pierpont_morgan_number="84200",
        louvre_number="cl010167094",
        ontario_number="385053",
        kelsey_number="0000.08.9402",
        harvard_ham_number="292034",
        etcsri_number="E2026-0014",
        sketchfab_number="d3217c4ed5f44f5c8267d4c3c97cfd7b",
        ark_number="13960/t5bd4577h",
        dublin_tcd_number="9019sc678",
        cambridge_maa_number="457838",
        ashmolean_number="764697",
        alalah_hpm_number="AlT 322",
        australianinstituteofarchaeology_number="aLoXiBERZm",
        philadelphia_number="452619",
        achemenet_number="1668744",
        nabucco_number="2259",
        digitale_keilschrift_bibliothek_number="P_ID=279&Z_CHK=40422",
        yale_peabody_number="BC.001863",
    )
    fragment = FragmentFactory.build(external_numbers=external_numbers)
