...
Authorization extension will also need a rule to add permissions in the token, 
but it can be autogenerated from the extension configuration.
Also, for RBAC *Add Permissions in the Access Token* must be set.
